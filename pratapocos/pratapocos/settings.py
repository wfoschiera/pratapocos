"""
Django settings for pratapocos project.
...
ALLOWED_HOSTS = config(
    "ALLOWED_HOSTS",
    default="pratapocos.fly.dev",
    cast=lambda v: [s.strip() for s in v.split(",")],
)

CSRF_TRUSTED_ORIGINS = config(
    "CSRF_TRUSTED_ORIGINS",
    default="https://pratapocos.fly.dev",
    cast=lambda v: [s.strip() for s in v.split(",")],
)
...
ROOT_URLCONF = "pratapocos.pratapocos.urls"
...
#             'filename': os.getenv('DJANGO_LOG_FILE', './pratapocos.log'),
#             'formatter': 'simple'
#         },
#     },
#     'loggers': {
